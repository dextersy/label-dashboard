/**
 * Local testing script for the Artist Balance Check Lambda function
 *
...
const mockContext: Context = {
  ...
  functionName: 'artist-balance-check',
  functionVersion: '$LATEST',
  invokedFunctionArn: 'arn:aws:lambda:us-east-1:123456789012:function:artist-balance-check',
  memoryLimitInMB: '512',
  awsRequestId: 'mock-request-id',
  logGroupName: '/aws/lambda/artist-balance-check',
...
const mockEvent: ScheduledEvent = {
  ...
  region: 'us-east-1',
  resources: ['arn:aws:events:us-east-1:123456789012:rule/artist-balance-check-daily'],
  detail: {},
};
...
async function runLocalTest() {
  ...
  try {
    ...
    if (result && result.statusCode === 200) {
      ...
      console.log('Check the superadmin email inbox for the balance summary.');
    } else {
