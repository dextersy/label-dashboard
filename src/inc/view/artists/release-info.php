            ...
            <div class="row">
                ...
                <input type="hidden" name="artist_id_1" value="<?=$_SESSION['current_artist'];?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="catalog_no" name="catalog_no" placeholder="Catalog Number" value="<?=$defaultCatNo;?>" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="UPC" name="UPC" placeholder="UPC/EAN code">
                    </div>  
                    <div class="form-group">
